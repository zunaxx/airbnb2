...
@ComponentScan(basePackages = "airbnb")
public class HibernateConfigure {
    @Autowired
    private final Environment environment;

    public HibernateConfigure(Environment environment) {
    ...
    public EntityManagerFactory entityManagerFactory(DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan("airbnb");
